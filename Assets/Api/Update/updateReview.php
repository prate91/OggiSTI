...
//declare in the order variable
  ...
  if ($result) {
    ...
    if ($resultInsert) {
      ...
      echo 'alert("Evento mandato in redazione!")';
      echo '</script>';
    ...
    echo '<script language="javascript">';
    echo 'alert("Problema con l\'invio in redazione!")';
    echo '</script>';
  }
  ...
  if ($reviser1 == 0 && $reviser2 == 0) { // Case 1: event without review
    ...
    if ($reviser1 == $userId) {
      ...
      if ($result) {
        ...
        echo '<script language="javascript">';
        echo 'alert("Evento approvato!")';
        echo '</script>';
        echo "<script>window.close();</script>";
      } else {
        //header("Location:../../PHP/OggiSTI_publishedEvents.php?message=errore");
        echo '<script language="javascript">';
        echo 'alert("Problema con l\'approvazione!")';
        echo '</script>';
      }
    }
  }
...
//declare in the order variable
  ...
  if ($result) {
    ...
    if ($resultUpdate) {
      ...
      //header("Location:../../PHP/OggiSTI_redactionEvents.php?message=redazione");
      echo '<script language="javascript">';
      echo 'alert("Evento inviato in redazione!")';
      echo '</script>';
      echo "<script>window.close();</script>";
    }
  } else {
