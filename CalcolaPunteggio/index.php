...
<div class="HMR_Banner">
	<script> creaHeader(2, 'HMR_2017g_GC-WebHeaderRite-270x105-3.png') </script>
</div>	
<div id="HMR_Menu" class="HMR_Menu" >
	<script> creaMenu(2, 5) </script>
</div>
...
<!-- Actual page content starts here ///////////////////////////////////////-->
	<div class="HMR_Content">
            ...
            for ($n = 0; $n <= 365; $n++) {
                ...
                if($giorniAnno[$n]==1){
                        echo '<td style="border: 1px solid #9E9E9E; background: #F293BA;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
                }else{
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if($row["fb"]==1){
                    echo ' <img src="../Assets/Img/iconFacebook.png" alt="FB Icon" width="10">';
                }
                echo "<br/>";
            }
...
<div class="HMR_Footer">    
    <script> creaFooter(2, '2017', '2018', 'Nicolò Pratelli - G.A.Cignoni', '07/13/2017') </script>
</div>
    </body>
</html>